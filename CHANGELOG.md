...
- **后端**: `/api/assets/:id/qrcode` 添加 `download` 字段
  ```json
  {
    ...
    "url": "https://...",
    "download": {
      "filename": "南孚电池-7 号 - 二维码.png",
      "name": "南孚电池 -7 号"
    }
  }
  ```
- **前端**: `showQRCode()` 函数添加资产名称显示和下载按钮
- **前端**: 新增 `downloadQRCode()` 函数实现下载功能
...
### v1.0.3
- 更新 CHANGELOG.md - 添加二维码下载功能说明

### v1.0.2
- 新增 CHANGELOG.md - 版本更新日志
- 新增 FEATURES_AND_SCHEMA.md - 功能与数据库结构
- 更新 README.md - 添加文档链接和 API 列表

### v1.0.1
- 新增 DATABASE_DICTIONARY.md - 数据库字典

---

**最后更新**: 2026-04-01 23:10 CST
